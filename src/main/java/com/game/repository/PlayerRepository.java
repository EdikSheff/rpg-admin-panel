...
public class PlayerRepository {
    private static final List<Player> storage = new CopyOnWriteArrayList<Player>() {{
        add(new Player(1L, "Nius", "Silent Walker", Race.HOBBIT, Profession.ROGUE, new Date(1244497480000L), false, 33));
        ...
        add(new Player(7L, "Eman", "Swift Soarer", Race.ELF, Profession.SORCERER, new Date(1214772360000L), false, 56));
        ...
        add(new Player(10L, "Derakt", "Red-Eared Elven", Race.ELF, Profession.ROGUE, new Date(1215043720000L), false, 55));
        add(new Player(12L, "Arhill", "Deadly", Race.GIANT, Profession.PALADIN, new Date(1243141000000L), false, 38));
        add(new Player(13L, "Endarion", "Little Elven", Race.ELF, Profession.DRUID, new Date(1219611120000L), false, 45));
        ...
        add(new Player(19L, "Jur", "Fighter with Thirst", Race.ORC, Profession.DRUID, new Date(1211860680000L), false, 23));
        add(new Player(20L, "Gron", "Doomed to Battle", Race.GIANT, Profession.PALADIN, new Date(1218401160000L), false, 58));
        ...
        add(new Player(25L, "Yrk", "Troll Bends Fir", Race.TROLL, Profession.WARRIOR, new Date(1244687920000L), true, 51));
        ...
        add(new Player(29L, "Solka", "Magic Apprentice", Race.ELF, Profession.SORCERER, new Date(1211843400000L), false, 54));
        ...
        add(new Player(33L, "Tant", "Devil Knot the Cotton", Race.DWARF, Profession.PALADIN, new Date(1214741200000L), false, 25));
        add(new Player(34L, "Trenigan", "Great Wizard", Race.ELF, Profession.SORCERER, new Date(1216020000000L), false, 42));
        add(new Player(35L, "Wudger", "Sad", Race.TROLL, Profession.NAZGUL, new Date(1210163720000L), false, 42));
        ...
        add(new Player(44L, "Regarn", "Lover of Olivier", Race.GIANT, Profession.WARRIOR, new Date(1197692680000L), false, 53));
        add(new Player(45L, "Angelli", "Young Fighter", Race.DWARF, Profession.WARRIOR, new Date(1247890000000L), false, 33));
        add(new Player(23L, "Gerris", "Imperial Warrior", Race.ORC, Profession.WARRIOR, new Date(1216630320000L), false, 58));
        add(new Player(46L, "Zhex", "Sunshine of Yarochka", Race.GIANT, Profession.WARRIOR, new Date(1214879560000L), false, 3));
        add(new Player(47L, "Philewell", "Chemist and Particle Physicist", Race.ELF, Profession.WARRIOR, new Date(1244445640000L), false, 30));
        ...
        add(new Player(52L, "Atteris", "Acting Carvandos", Race.ELF, Profession.SORCERER, new Date(1245050800000L), true, 34));
    }};
